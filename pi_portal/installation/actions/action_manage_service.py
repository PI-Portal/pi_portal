"""ManageServiceAction class."""
import enum

from pi_portal.installation.services.bases import service_definition
from .bases import base_system_call_action


class ServiceOperation(enum.Enum):
  """Operations that can be performed on linux services."""
...
class ManageServiceAction(base_system_call_action.SystemCallActionBase):
  """Manage a linux service."""

  service: service_definition.ServiceDefinition
  operation: ServiceOperation

  def invoke(self) -> None:
    """Manage a linux service."""

    method = getattr(self, self.operation.value)
    method()
  ...
  def _disable_via_system_v(self) -> bool:
    try:
      ...
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
  ...
  def _disable_via_systemd(self) -> bool:
    try:
      self.system_call(f"systemctl disable {self.service.systemd_unit_name}")
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
  ...
  def _enable_via_systemd(self) -> bool:
    try:
      self.system_call(f"systemctl enable {self.service.systemd_unit_name}")
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
  ...
  def _start_via_system_v(self) -> bool:
    try:
      self.system_call(f"service {self.service.system_v_service_name} start")
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
  ...
  def _start_via_systemd(self) -> bool:
    try:
      self.system_call(f"systemctl start {self.service.systemd_unit_name}")
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
  ...
  def _stop_via_system_v(self) -> bool:
    try:
      self.system_call(f"service {self.service.system_v_service_name} stop")
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
  ...
  def _stop_via_systemd(self) -> bool:
    try:
      self.system_call(f"systemctl stop {self.service.systemd_unit_name}")
      return True
    except base_system_call_action.SystemCallError:
      self.log.warning(
