...
CRON_INTERVAL_MANIFEST_METRICS = 60 * 10
CRON_INTERVAL_QUEUE_MAINTENANCE = 60 * 60 * 24
CRON_INTERVAL_QUEUE_METRICS = 60 * 10
CRON_INTERVAL_SYSTEM_METRICS = 60
...
LOG_FILE_METRICS = f"{LOG_FILE_BASE_FOLDER}/pi_portal.metrics.log"
