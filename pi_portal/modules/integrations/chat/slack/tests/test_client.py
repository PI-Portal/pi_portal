...
class TestSlackClient:
  ...
  def test_initialize__slack_web_client__chat(
      self,
      slack_client_instance: client.SlackClient,
  ...
  def test_send_message__vary_exception__retries_calling_slack_client(
      self,
      slack_client_instance: client.SlackClient,
      mocked_slack_web_client_chat: mock.Mock,
      exception: Exception,
  ...
  def test_send_file__vary_exception__retries_calling_slack_client(
      self,
      slack_client_instance: client.SlackClient,
      mocked_slack_web_client_files: mock.Mock,
      exception: Exception,
